 ...
 */
final class Version20210106153217 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE navire (id INT AUTO_INCREMENT NOT NULL, idpays INT NOT NULL, idportdestination INT DEFAULT NULL, imo VARCHAR(7) NOT NULL, nom VARCHAR(100) NOT NULL, mmsi VARCHAR(9) NOT NULL, indicatifAppel VARCHAR(10) NOT NULL, eta DATETIME NOT NULL, idaisshiptype VARCHAR(255) NOT NULL, longueur INT NOT NULL, largeur INT NOT NULL, tirantdeau NUMERIC(10, 1) NOT NULL, UNIQUE INDEX UNIQ_EED1038B519409E (imo), INDEX IDX_EED1038E750CD0E (idpays), INDEX IDX_EED1038427CFE1F (idportdestination), UNIQUE INDEX mmsi_unique (mmsi), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
